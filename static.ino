...
void readinputs(){
    Serial3.print("fcLeft:");  Serial3.print(digitalRead(fcLeft)); Serial3.print(" ");
    Serial3.print("fcRight:"); Serial3.print(digitalRead(fcRight)); Serial3.print(" ");
    Serial3.print("bpause:");  Serial3.print(digitalRead(bpause)); Serial3.print(" ");
    Serial3.print("stepCounter:");  Serial3.print(stepCounter); Serial3.print(" ");
    Serial3.println();
}
...
void displayValues(){
    Serial3.print(curntTTotal); Serial3.print(" ");
    Serial3.print(curntTEsfz);  Serial3.print(" ");
    Serial3.print(curntTDesc);  Serial3.print(" ");
    Serial3.print(curntEsfz,1); Serial3.print(" ");
    if (efforFlag){
        if (curntAlt)
...
void processingRemoteData(char c){
    ...
    if (cbuffer>=buffersize) cbuffer=0;
}

void comparator(void){
    Serial.println(" ");
    if (findCommand(startCommand)) {
        startFlag = true; efforFlag=true; 
...
void getConfig(){
    ...
    Serial.print("TTot: ");  Serial.println(confTTotal);
    Serial.print("TEsf: ");  Serial.println(confTEsfz);
    Serial.print("TDes: ");  Serial.println(confTDesc);
    Serial.print("Esfz: ");  Serial.println(confEsfz);
    Serial.print("Alt:  ");  Serial.println(confAlt);
}
...
void one_ms(){
    ...
    if (secCount>=999){
        ...
        if(startFlag){
            curntTTotal++;
            if(efforFlag)  curntTEsfz++;
            if(!efforFlag) curntTDesc++;
